      ...
      <div className={styles.card} style={{ textAlign: 'center' }}>
          ...
          {ok ? (
            <>
              ...
              <p className={styles.sub}>
                {isSample
                  ? "Your full 14-page sample proposal is on its way to your inbox — same link is below too, in case email is slow."
                  : "Monday's digest of real federal product solicitations is on its way to your inbox each week. Unsubscribe anytime with one click from any digest email."}
              </p>
            </>
          ) : (
            <>
        ...
        {ok && isSample && (
          <div style={{ textAlign: 'left', marginTop: 'var(--sp-6, 24px)' }}>
            <a
              href="/images/samples/govcon-lab-sample-proposal.pdf"
              target="_blank"
              rel="noopener"
              style={{
                display: 'block',
            ...
            >
              Open the full 14-page sample PDF →
            </a>
            <p style={{ fontSize: 13, color: 'var(--text-2, #4A5568)', margin: '0 0 var(--sp-4, 16px)' }}>
