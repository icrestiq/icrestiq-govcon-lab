...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Determine mode from price ID prefix (subscriptions use recurring prices)
    // You can also add a 'mode' column to your products table if needed
    const isSubscription = product.stripe_price_id.includes('sub') || false
